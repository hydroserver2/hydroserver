...
class MonitoringSite(HydroServerBaseModel):
    ...
    def workspace(self) -> "Workspace":
        """The workspace this monitoring_site belongs to."""
    ...
    def datastreams(self) -> List["Datastream"]:
        """The datastreams collected at this monitoring_site."""
    ...
    def add_file_attachment(self, file: IO[bytes], file_attachment_type: str):
        """Add a file attachment for this monitoring_site."""
    ...
    def delete_file_attachment(self, name: str):
        """Delete a file attachment of this monitoring_site."""
