...
export namespace TaskContract {
  ...
  export type SummaryResponse = Data.components['schemas']['DataIngestionWindowBoundaryResponse']
  export type DetailResponse  = Data.components['schemas']['DataIngestionWindowBoundaryResponse']
