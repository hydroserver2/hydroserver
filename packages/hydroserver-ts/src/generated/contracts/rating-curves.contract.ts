/* Contract for Rating Curves.
   Parallels the hand-maintained product task contracts. */
import type * as Data from '../data.types'

export namespace RatingCurveContract {
  export const route = 'rating-curves' as const
  export type QueryParameters =
    ([Data.operations['interfaces_api_views_products_rating_curve_get_rating_curves']['parameters']['query']] extends [never]
      ? {}
      : NonNullable<Data.operations['interfaces_api_views_products_rating_curve_get_rating_curves']['parameters']['query']>)
