...
export namespace DataProductTaskContract {
  ...
  export type SummaryResponse = Data.components['schemas']['DataProductTaskSummaryResponse']
  export type DetailResponse  = Data.components['schemas']['DataProductTaskDetailResponse']
