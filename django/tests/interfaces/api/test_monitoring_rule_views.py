...
def test_get_monitoring_rules_orders_by_rule_type(client):
    ...
    response = client.get(RULES_URL, {"task_id": str(task.id), "order_by": "ruleType"})
...
def test_get_monitoring_rules_orders_by_datastream_id(client):
    ...
    response = client.get(RULES_URL, {"task_id": str(task.id), "order_by": "-datastreamId"})
...
def test_get_monitoring_rules_order_by_rejects_unknown_field(client):
    ...
    response = client.get(RULES_URL, {"task_id": str(task.id), "order_by": "bogus"})
