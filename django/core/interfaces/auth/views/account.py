...
from core.interfaces.http.auth import bearer_auth, session_auth
...
from core.interfaces.auth.schemas import AccountDetailResponse, AccountPostBody, AccountPatchBody
