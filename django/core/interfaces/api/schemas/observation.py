...
from core.interfaces.api.types import ISODatetime
from core.interfaces.api.types.iso_datetime import validate_iso_datetime
...
if TYPE_CHECKING:
    ...
    from core.interfaces.api.schemas import DatastreamSummaryResponse
