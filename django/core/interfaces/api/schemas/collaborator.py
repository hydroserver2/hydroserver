...
from core.interfaces.api.schemas import BaseGetResponse, BasePostBody, CollectionQueryParameters

if TYPE_CHECKING:
    from core.interfaces.api.schemas import RoleSummaryResponse, AccountContactDetailResponse
