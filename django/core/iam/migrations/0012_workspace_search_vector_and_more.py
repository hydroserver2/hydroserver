...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('iam', '0011_alter_collaborator_unique_workspace_user_collaborator_and_more'),
    ]
    ...
    operations = [
        ...
        *_search_vector_trigger_sql("iam_workspace", {"name": "A"}),
        migrations.AddIndex(
            model_name='workspace',
            index=django.contrib.postgres.indexes.GinIndex(fields=['search_vector'], name='iam_workspace_search_gin'),
        ),
    ]
