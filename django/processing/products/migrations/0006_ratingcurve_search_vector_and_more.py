...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('products', '0005_ratingcurvepoint_unique_rating_curve_point_input_value'),
    ...
    operations = [
        ...
        *_search_vector_trigger_sql(
        ...
        migrations.AddIndex(
            model_name='ratingcurve',
            index=django.contrib.postgres.indexes.GinIndex(fields=['search_vector'], name='products_ratingcurve_search'),
        ),
    ]
