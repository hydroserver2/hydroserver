...
@qc_session_router.get(
    "",
    auth=_auth,
    response={200: list[QualityControlSessionSummaryResponse], 401: str, 403: str, 404: str},
    by_alias=True,
)
def get_qc_sessions(
...
@qc_session_router.get(
    "/{session_id}",
    auth=_auth,
    response={200: QualityControlSessionDetailResponse, 401: str, 403: str, 404: str},
    by_alias=True,
)
def get_qc_session(
    request: HydroServerHttpRequest,
    ...
    """Get a QC session by ID, including its dependencies and operations."""
