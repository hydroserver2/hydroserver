...
The following is an entity relationship diagram illustrating the HydroServer data model design. You can also access a [data dictionary](/references/data-dictionary.md) that describes each of the entities and attributes along with data types and descriptive information.
