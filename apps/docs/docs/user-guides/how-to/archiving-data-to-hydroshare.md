# Archiving Data to HydroShare

:::warning Archival to HydroShare is currently disabled.
It will be added back into HydroServer's functionality via the Job Orchestration System, but is not currently functional.
:::
