...
<img src="/Quality/1 Click Quality.png" alt="Open the Quality section and add a quality monitoring task" width="550">
...
<img src="/Quality/2CreateQualityTask.png" alt="Create a quality monitoring task with a range rule for discharge" width="550">
