...
If you are looking for developer / deployment docs for the QC App, start
with the QC App
[ARCHITECTURE](https://github.com/hydroserver2/hydroserver-qc-app/blob/main/docs/ARCHITECTURE.md)
...
COOP/COEP configuration (the QC App
[DEPLOYMENT](https://github.com/hydroserver2/hydroserver-qc-app/blob/main/docs/DEPLOYMENT.md)
...
> themselves are not yet serialized to the backend on Save. See the QC
> App
> [QUALITY](https://github.com/hydroserver2/hydroserver-qc-app/blob/main/docs/QUALITY.md)
...
See the QC App
[PERFORMANCE](https://github.com/hydroserver2/hydroserver-qc-app/blob/main/docs/PERFORMANCE.md)
documentation for the envelope details.
...
- [HydroServer QC App repository](https://github.com/hydroserver2/hydroserver-qc-app)
