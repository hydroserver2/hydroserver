# Set Up Automated Data Ingestion with Python

This tutorial explains how to use the `hydroserverpy` Python library to automatically load data from external web sources into HydroServer. You'll configure two things:
