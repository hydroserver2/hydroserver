# HydroServer Resource Identifiers (UUIDs)

HydroServer uses universally unique identifiers (UUIDs) within its database to uniquely identify monitoring sites, observed properties, datastreams, etc. This is important because many interactions with HydroServer's APIs use these UUIDs for data retrieval.
