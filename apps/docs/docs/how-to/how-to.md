...
* **[Set up a HydroServer Local Development Environment](/how-to/development/development-setup.md)**: Learn how to set HydroServer for local development.

* **[Deployment](/how-to/deployment/production-deployment-overview.md)**: Learn how to deploy a HydroServer instance.

* **[Customize the Data Management Web App](/how-to/data-management-app/customize.md)**: Learn about options for customizing the look and feel of the Data Management Web App.

* **[TypeScript Client](/how-to/typescript-client/typescript-client-examples.md)**: Learn how to use the HydroServer TypeScript client for web application development.
